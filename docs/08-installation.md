...
Hauser `v0.4.0-beta.6` is the current public technical beta. Once a tag passes
the release workflow, the release package uses
`ghcr.io/ralleur/hauser:v0.4.0-beta.6`. An explicit source-build overlay remains
