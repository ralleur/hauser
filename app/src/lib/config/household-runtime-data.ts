import {
  ...
  LAUNDRY_ENTITIES as LEGACY_LAUNDRY_ENTITIES,
...
import type { HouseholdRuntimeModel, ModuleId, VisibleEntityConfig } from './household-config.ts';
...
export function projectActiveHouseholdData(model: HouseholdRuntimeModel): ProjectedHouseholdData {
  ...
  return {
    ...
    LAUNDRY_ENTITIES: { ...model.globalEntities.laundry },
...
export function resetHouseholdDataToLegacy(): void {
  ...
  LAUNDRY_ENTITIES = LEGACY_LAUNDRY_ENTITIES;
